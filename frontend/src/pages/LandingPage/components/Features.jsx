      ...
      <div className='container mx-auto px-4 relative z-10'>
        <div className='text-center mb-16'>
          <h2 className='text-4xl md:text-5xl font-bold text-gray-900 mb-6'>
            ...
            <span className='block bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'>Succeed</span>
          </h2>
        ...
        <div className='grid md:grid-cols-2 gap-16 lg:gap-24'>
            ...
            <div className='space-y-8'>
              {
                jobSeekerFeatures.map((feature, index) => (
                  ...
                  className='group flex items-start space-x-4 p-6 rounded-2xl hover:bg-blue-50 transition-all duration-300 cursor-pointer'>
                    <div className='shrink-0 w-12 h-12 flex items-center justify-center bg-blue-100 rounded-xl group-hover:bg-blue-200 transition-colors'>
          ...
          <div>
            <div className='text-center mb-12'>
              ...
              <div className='w-24 h-1 bg-linear-to-r from-purple-500 to-purple-600 mx-auto rounded-full'></div>
            </div>
