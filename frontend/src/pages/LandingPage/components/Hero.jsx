  ...
  return (
    <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            >
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold text-lg border-2 border-blue-600 hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl"
              onClick={() => {
                navigate(
                ...
                <motion.div
                  ...
                  >
                    <div className="w-12 h-12 bg-linear-to-r from-blue-100 to-purple-100 rounded-xl flex items-center justify-center mb-2">
                      ...
                      <div className="text-sm text-gray-600 font-medium">{stat.value}</div>
                </motion.div>
              ))}
            </motion.div>
        </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linear-to-r from-blue-50 to-purple-50 rounded-full blur-3xl opacity-20"></div>
      </div>
    </section>
  )
}
